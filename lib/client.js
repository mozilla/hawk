...
/*
    ...
    artifacts:  object recieved from header()
    payload:    optional payload received
*/

exports.authenticate = function (res, artifacts, payload) {
    ...
    var calculatedHash = Crypto.calculateHash(payload, artifacts.credentials.algorithm, res.headers['content-type']);
...
/*
    res:            node's response object
    credentials:    credentials used in header()
*/

exports.validateTimestamp = function (res, credentials) {
    ...
    return Cryptiles.fixedTimeComparison(tsm, attributes.tsm);
};
