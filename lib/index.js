 ...
 *                        Defaults to 0.
 *
 * ntp                  - optional hostname of the ntp server used to synchronize the server's clock (application time only).
 *                        Used by the SNTP client to calculate the local time offset. Defaults to 'pool.ntp.org'.
 *
